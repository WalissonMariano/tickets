            ...
            @else
                <div class="index-page-table-wrap">
                    <table class="index-page-table">
                        <thead>
                            <tr>
                                <th class="index-page-col--actions"></th>
                                <th>Código</th>
                                <th class="index-page-col--title">Título</th>
                                <th>Projeto</th>
                                <th>Solicitante</th>
                                <th>Responsável</th>
                                <th>Gravidade</th>
                        ...
                        <tbody>
                            @foreach ($tasks as $task)
                                <tr>
                                    <td class="index-page-col--actions index-page-actions">
                                        <a href="{{ route('tasks.edit', $task) }}" class="index-page-action-link" title="Editar" aria-label="Editar tarefa #{{ $task->code }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
